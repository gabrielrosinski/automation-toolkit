...
// Bug 1: Missing quotes around filename
...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        // Bug 4: Wrong variable name (usrname vs username)
        ...
        if (empty($username) || empty($email) {
            ...
            // Bug 6: Typo in function name (sanityze vs sanitize)
            $username = sanityze_input($username);
    ...
    // Bug 8: Wrong array syntax (missing $)
    echo "<table>";
